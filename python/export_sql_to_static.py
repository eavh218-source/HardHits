...
def normalize_game_weather_row(row: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "away_display": stringify(row.get("away_display"), stringify(row.get("away_team"))),
        "home_display": stringify(row.get("home_display"), stringify(row.get("home_team"))),
        "away_logo_url": stringify(row.get("away_logo_url")),
        "home_logo_url": stringify(row.get("home_logo_url")),
        "field_image_url": stringify(row.get("field_image_url")),
        "weather_icon_url": stringify(row.get("weather_icon_url")),
        ...
        "center_field_direction": stringify(row.get("center_field_direction")),
        "wind_outlook": stringify(row.get("wind_outlook")),
        "weather_score": safe_int(row.get("weather_score"), 50),
        "source": stringify(row.get("source_name") or row.get("source"), "covers"),
